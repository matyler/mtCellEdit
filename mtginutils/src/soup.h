...
public:
	...
	inline char const * get_input_filename () const
...
/// ----------------------------------------------------------------------------
	...
	mtGin::App		gin;
	mtGin::AudioFileRead	audio_file;
	mtGin::AudioPlay	audio_play;
...
/// ----------------------------------------------------------------------------
	...
	int			m_device		= -1;
	int			m_gui			= 0;
	char		const *	m_input_filename	= nullptr;
