...
Summary:		Qt5 Crypto and Random Data Program
License:		GPLv3+
Source:			%{name}-%{version}.tar.gz
BuildRequires:		libmtkit libmtpixy libmtdatawell libmtqex5 qt5-qtbase-devel
Requires:		libmtkit libmtpixy libmtdatawell libmtqex5 qt5-qtbase
