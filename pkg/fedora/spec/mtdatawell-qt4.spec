...
Summary:		Qt4 Crypto and Random Data Program
License:		GPLv3+
Source:			%{name}-%{version}.tar.gz
BuildRequires:		libmtkit libmtpixy libmtdatawell libmtqex4 qt-devel
Requires:		libmtkit libmtpixy libmtdatawell libmtqex4 qt
