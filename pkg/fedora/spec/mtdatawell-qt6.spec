...
Summary:		Qt6 Crypto and Random Data Program
License:		GPLv3+
Source:			%{name}-%{version}.tar.gz
BuildRequires:		libmtkit libmtpixy libmtdatawell libmtqex6 qt6-qtbase-devel
Requires:		libmtkit libmtpixy libmtdatawell libmtqex6 qt6-qtbase
