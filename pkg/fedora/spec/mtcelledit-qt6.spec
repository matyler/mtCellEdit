...
Summary:		Qt6 Spreadsheet GUI
License:		GPLv3+
Source:			%{name}-%{version}.tar.gz
BuildRequires:		libmtkit libmtcelledit libmtpixy libmtqex6 qt6-qtbase-devel inkscape
Requires:		libmtkit libmtcelledit libmtpixy libmtqex6 qt6-qtbase
