...
Summary:		Qt6 Mark Tyler's Wave Audio Synthesiser Program
License:		GPLv3+
Source:			%{name}-%{version}.tar.gz
BuildRequires:		libmtkit libmtgin libmtdatawell libmtqex6 qt6-base-devel inkscape libSDL2-devel
Requires:		libmtkit libmtgin libmtdatawell libmtqex6 libQt6Core6 libSDL2-2_0-0
