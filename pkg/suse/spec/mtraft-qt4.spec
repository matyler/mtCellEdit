...
Summary:		Qt4 Directory Analysis Tool
License:		GPLv3+
Source:			%{name}-%{version}.tar.gz
BuildRequires:		libmtkit libmtcelledit libmtqex4 libqt4-devel inkscape
Requires:		libmtkit libmtcelledit libmtqex4 libqt4
