...
int cedut_append ( void )
{
	...
	{
		res = 1;	// Fail, and tell user load failed
	...
	{
		res = 2;	// Fail, and tell user libmtcelledit failed
...
int cedut_clear ( void )
{
	...
	if ( ut_load_file () )
	{
		return 1;	// Fail, and tell user load failed
	}
	...
	{
		return 2;	// Fail, and tell user libmtcelledit failed
	}
...
int cedut_flip ( void )
{
	...
	if ( ! sheet )
	{
		return 2;	// Get caller to report libmtcelledit error
	}
