...
int cedut_clear ( void )
{
	...
	int const r = global.i_range[0];
	int const c = global.i_range[2];
	int const rtot = global.i_range[1] - r + 1;
	int const ctot = global.i_range[3] - c + 1;
