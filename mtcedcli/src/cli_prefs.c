	...
	)
{
	...
	if ( cedcli_get_integer ( args[1], &num, 0, -1 ) )
	{
		return 1;
	}
	...
	)
{
	...
	if ( match_chint ( args[0], ctab, &pref_id ) )
	{
	...
	)
{
	...
	if ( cedcli_get_integer ( args[0], &num, CUI_CELLBORD_MIN,
		CUI_CELLBORD_MAX )
		)
	{
		return 1;
