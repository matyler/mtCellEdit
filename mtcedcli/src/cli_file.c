	...
	)
{
	CedBookFile	* graph;
	int		filetype;
	static charINT	const graph_types[] = {
	...
	if ( match_chint ( args[1], graph_types, &filetype ) )
	{
	...
	)
{
	...
	int		row_pad = 1;
	static charINT	const sheet_types[] = {
	...
	if ( match_chint ( args[1], sheet_types, &filetype ) )
	{
