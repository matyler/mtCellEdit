	...
	)
{
	...
	{
		state.sort_array[ state.i ] = tnode->data;
...
*/
	...
	state.sort_array = calloc ( (size_t)state.active_rows,
		sizeof (mtTree *) );

	state.tn_array = calloc ( (size_t)state.active_rows,
		sizeof (mtTreeNode *) );
	...
	)
{
	...
	state.csortn = calloc ( (size_t)state.active_cols, sizeof ( csortNODE));
	state.csorti = calloc ( (size_t)state.active_cols, sizeof ( int ) );
	state.tn_array = calloc ( (size_t)state.active_cols,
		sizeof (mtTreeNode *) );
