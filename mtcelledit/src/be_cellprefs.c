	...
	)
{
	...
	{ CED_FILE_PREFS_CELL_ALIGN_HORIZONTAL, MTKIT_PREF_TYPE_OPTION, "0", _("Horizontal text alignment"), callback, CUI_CELLPREFS_align_horizontal, "None	Left	Centre	Right", ptr },
	{ CED_FILE_PREFS_CELL_COLOR_BACKGROUND, MTKIT_PREF_TYPE_RGB, "16777215", _("Cell background colour"), callback, CUI_CELLPREFS_color_background, NULL, ptr },
	{ CED_FILE_PREFS_CELL_COLOR_FOREGROUND, MTKIT_PREF_TYPE_RGB, "0", _("Text foreground colour"), callback, CUI_CELLPREFS_color_foreground, NULL, ptr },
	{ CED_FILE_PREFS_CELL_FORMAT, MTKIT_PREF_TYPE_OPTION, "0", _("Cell format"), callback, CUI_CELLPREFS_format, "General	Text	Fixed Decimal	Hexadecimal	Binary	Scientific	Percentage	Datetime", ptr },
	{ CED_FILE_PREFS_CELL_FORMAT_DATETIME, MTKIT_PREF_TYPE_STR, "", _("Datetime format e.g. d/m/y HH:MM:SS"), callback, CUI_CELLPREFS_format_datetime, "32", ptr },
	{ CED_FILE_PREFS_CELL_NUM_DECIMAL_PLACES, MTKIT_PREF_TYPE_INT, "0", _("Number of decimal places for fixed type"), callback, CUI_CELLPREFS_num_decimal_places, "0	99", ptr },
	{ CED_FILE_PREFS_CELL_NUM_THOUSANDS, MTKIT_PREF_TYPE_STR, "", _("Thousands separator character"), callback, CUI_CELLPREFS_num_thousands, "1", ptr },
	{ CED_FILE_PREFS_CELL_NUM_ZEROS, MTKIT_PREF_TYPE_INT, "0", _("Leading zeros"), callback, CUI_CELLPREFS_num_zeros, "0	32", ptr },
	{ CED_FILE_PREFS_CELL_TEXT_STYLE, MTKIT_PREF_TYPE_INT, "0", _("Text style"), callback, CUI_CELLPREFS_text_style, NULL, ptr },
	{ CED_FILE_PREFS_CELL_LOCKED, MTKIT_PREF_TYPE_BOOL, "0", _("Cell locked - read only"), callback, CUI_CELLPREFS_locked, NULL, ptr },
	{ CED_FILE_PREFS_CELL_BORDER_TYPE, MTKIT_PREF_TYPE_INT, "0", _("Border type"), callback, CUI_CELLPREFS_border_type, "0	1073741823", ptr },
	{ CED_FILE_PREFS_CELL_BORDER_COLOR, MTKIT_PREF_TYPE_RGB, "0", _("Border colour"), callback, CUI_CELLPREFS_border_color, NULL, ptr },
	{ CED_FILE_PREFS_CELL_TEXT_PREFIX, MTKIT_PREF_TYPE_STR, "", _("Cell text prefix"), callback, CUI_CELLPREFS_text_prefix, NULL, ptr },
	{ CED_FILE_PREFS_CELL_TEXT_SUFFIX, MTKIT_PREF_TYPE_STR, "", _("Cell text suffix"), callback, CUI_CELLPREFS_text_suffix, NULL, ptr },
	{ NULL }
	};
	...
	if ( prefs && cell_prefs )
	{
		be_cellpref_bulk_import ( prefs, cell_prefs );
	}
	...
	)
{
	...
	mtkit_prefs_value_copy ( prefs_file (), prefs, winprefs_shared_main );
	mtkit_prefs_value_copy ( prefs, prefs_file (), winprefs_main_main );
}
	...
	)
{
	...
	mtkit_prefs_value_copy ( prefs, prefs_file (), winprefs_main_shared );
}
