...
/// -------------- Math errors -------------------------------------------------
	...
	// Parsing errors
	, ERROR_MISSING_PAREN_OPEN
	, ERROR_MISSING_PAREN_CLOSE

	, ERROR_BAD_SYNTAX

	, ERROR_VARIABLE_UNDEFINED

	, ERROR_FUNCTION_UNKNOWN
	, ERROR_FUNCTION_ARGS_TOO_FEW
	, ERROR_FUNCTION_ARGS_TOO_MANY

	, ERROR_DIVIDE_BY_ZERO
	, ERROR_BAD_POWER

	, ERROR_EVAL_TEXT_NULL
	, ERROR_EVAL_TEXT_TOO_LARGE
