...
#include "math_float_funcs.h"



namespace FUN = mtDW::FloatFunc;



void mtDW::FloatGrammar::parse_nt_func (
...
int mtDW::FloatParser::get_function_data (
	int		const	index,
