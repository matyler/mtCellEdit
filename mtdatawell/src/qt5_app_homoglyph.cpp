...
DialogHomoglyphs::DialogHomoglyphs ( Mainwindow &mw )
	:
	QDialog			( &mw ),
...
///	ENCODE tab
	...
	m_file_enc_overt = new fileCombo ( mw.uprefs, "Input UTF-8 File",
		QFileDialog::ExistingFile );
	vbox->addWidget ( m_file_enc_overt );

	m_file_enc_covert = new fileCombo ( mw.uprefs, "Input Covert File",
		QFileDialog::ExistingFile );
	vbox->addWidget ( m_file_enc_covert );

	m_file_enc_output = new fileCombo ( mw.uprefs, "Output UTF-8 File",
		QFileDialog::AnyFile );
...
///	DECODE tab
	...
	m_file_dec_input = new fileCombo ( mw.uprefs, "Input UTF-8 File",
		QFileDialog::ExistingFile );
	vbox->addWidget ( m_file_dec_input );

	m_file_dec_output = new fileCombo ( mw.uprefs, "Ouput File",
		QFileDialog::AnyFile );
